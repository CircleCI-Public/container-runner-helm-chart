...
![Version: 101.1.9](https://img.shields.io/badge/Version-101.1.9-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 3.1.10](https://img.shields.io/badge/AppVersion-3.1.10-informational?style=flat-square)
...
| agent.image | object | `{"digest":"","pullPolicy":"Always","registry":"","repository":"circleci/runner-agent","tag":"kubernetes-3.1.10-9364-c2cdf12"}` | Agent image settings. NOTE: Setting an image digest will take precedence over the image tag |
...
| logging | object | `{"image":{"registry":"","repository":"circleci/logging-collector","tag":"3.1.10-9364-c2cdf12"},"rbac":{"create":true,"role":{"name":"logging-collector","rules":[]}},"serviceAccount":{"annotations":{},"create":true,"name":"logging-collector","secret":{"name":"logging-collector-token"}}}` | Configuration values for the logging containers. These containers run alongside service containers and stream their logs to the CircleCI UI |
...
| logging.image.tag | string | `"3.1.10-9364-c2cdf12"` | Image tag for the logging collector. Should match container agent version to ensure compatibility. |
